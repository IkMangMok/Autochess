...
{
    auto temp = Chess::createChess("walnut.png", Point(rand() % 1000, rand() % 1000));
...
{
    auto s_layer = LayerColor::create();
    s_layer->setPosition(300, 300);
    s_layer->changeHeight(180);
    s_layer->changeWidth(180);
    this->addChild(s_layer, 1);

    auto sprite1 = Sprite::create("walnut.png");
